function [gratingid, gratingrect] = CreateProceduralSmoothedAnnulusSineGrating(windowPtr, width, height, backgroundColorOffset, radius, contrastPreMultiplicator, sigma, useAlpha, method)
...
if all(isinf(radius))
    ...
    gratingShader = LoadGLSLProgramFromFiles('SineGratingSmoothedAnnulusShader', debuglevel);
end
